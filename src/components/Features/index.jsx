...
function Features() {
  AOS.init({offset: 140,});
  return (
    <section id='features' className="features-bg-con">
       ...
       <div className="features-cards-con" data-aos="fade-right" >
        ...
        <div className='feature-card2' data-aos="fade-left" >
        ...
        <div className='feature-card1' data-aos="fade-right">
